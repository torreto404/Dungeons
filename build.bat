...
gcc -c src/map.c -o build/map.o -Iinclude

gcc build/main.o build/init.o build/character.o build/game.o build/combat.o build/ai.o build/map.o -o bin/main.exe
